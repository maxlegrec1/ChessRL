...
dir_path = "/mnt/2tb/LeelaDataReader/parquet_shuffled_final"
gen = batch_generator(dir_path, batch_size=1550, block_size=1, return_fen=False, triple=True, device='cuda')
