...
input_dir = "/mnt/2tb/LeelaDataReader/parquet_shuffled"
...
def process_probabilities(fen, white_win, draw_prob, black_win):
    """
    ...
    """
    return np.array([black_win, draw_prob, white_win])
            ...
            try:
                ...
                for start_idx in range(0, len(row_group_df), batch_size):
                    ...
                    for _, row in batch_df.iterrows():
                        ...
                        outcome_index = process_probabilities(fen, white_win, draw_prob, black_win)
