...
model = convert_to_float8_training(model, config=float8_config)
...
gen = dir_iterator(dir_path,triple = True,batch_size = 400, all_elo = True)
...
for i in progress_bar:
    ...
    if (i + 1) % 10000 == 0:
        checkpoint_path = f"pretrain/extra_long_checkpoint_step_{i+1}.pt"
