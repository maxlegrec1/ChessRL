...
from model_fp8 import GPT, GPTConfig
...
gen = dir_iterator(dir_path,triple = True,batch_size = 200, all_elo = True)
...
for i in progress_bar:
    ...
    with te.fp8_autocast(enabled=True, fp8_recipe=fp8_recipe):  # Enable mixed precision
    ...
    if (i + 1) % 10000 == 0:
        checkpoint_path = f"pretrain/fp8_test_{i+1}.pt"
